    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          {(() => {
            const pd = { bukhta: { addr: 'Мытищи · Пироговское водохранилище', tags: ['Пейнтбол','Лазертаг','Квесты','Беседки','Тимбилдинг'] }, sofrino: { addr: 'Пушкинский р-н · Софрино', tags: ['Пейнтбол','Лазертаг','Квадроциклы','Джиппинг','Хаски','Верёвочный парк'] } }[activePark]
            return (
      ...
      <section className="s" id="gallery" style={{ background: 'var(--bg2)' }}>
        ...
        <div className="gal-more rv">
          <span className="gal-more-txt">Ещё больше фото и видео с наших площадок —</span>
          <a href="https://t.me/plpark" target="_blank" rel="noreferrer" className="gal-more-link">
